...
export const DASHBOARD_SHOWCASE_METAGAME_DECKS: DeckGalleryItem[] = [
  {
    revisionId: 201,
    name: 'Mono-Green Devotion',
    format: 'Standard',
    archetype: '12.06% of the field',
    colors: ['G'],
    wins: 290,
    losses: 232,
    ties: 0,
    featuredCards: [
      { catalogId: 11, name: 'Llanowar Elves' },
      { catalogId: 12, name: 'Elvish Mystic' },
      { catalogId: 13, name: 'Nykthos, Shrine to Nyx' },
      { catalogId: 14, name: 'Karn, the Great Creator' },
      { catalogId: 15, name: 'Cavalier of Thorns' },
    ],
  },
  {
    revisionId: 202,
    ...
    format: 'Modern',
    archetype: '9.28% of the field',
    colors: ['W', 'U', 'B', 'G'],
    wins: 283,
    losses: 272,
    ties: 0,
    featuredCards: [
      { catalogId: 21, name: "Goryo's Vengeance" },
      { catalogId: 22, name: 'Atraxa, Grand Unifier' },
      { catalogId: 23, name: 'Psychic Frog' },
      { catalogId: 24, name: 'Thoughtseize' },
      { catalogId: 25, name: 'Undercity Sewers' },
    ],
  },
  {
    revisionId: 203,
    name: 'Izzet Prowess',
    format: 'Pioneer',
    archetype: '18.85% of the field',
    colors: ['U', 'R'],
    wins: 271,
    losses: 303,
    ties: 0,
    featuredCards: [
      { catalogId: 31, name: 'Slickshot Show-Off' },
      { catalogId: 32, name: 'Monastery Swiftspear' },
      { catalogId: 33, name: 'Opt' },
      { catalogId: 34, name: 'Consider' },
      { catalogId: 35, name: 'Steam Vents' },
    ],
  },
  {
    revisionId: 204,
    name: 'Raker Shops',
    format: 'Vintage',
    archetype: '22.25% of the field',
    colors: [],
    wins: 190,
    losses: 171,
    ties: 0,
    featuredCards: [
      { catalogId: 41, name: 'Mishra\'s Workshop' },
      { catalogId: 42, name: 'Ancient Tomb' },
      { catalogId: 43, name: 'Sphere of Resistance' },
      { catalogId: 44, name: 'The One Ring' },
      { catalogId: 45, name: 'Wasteland' },
    ],
  },
  {
    revisionId: 205,
    name: 'Dimir Tempo',
    format: 'Legacy',
    archetype: '12.28% of the field',
    colors: ['U', 'B'],
    wins: 180,
    losses: 146,
    ties: 0,
    featuredCards: [
      { catalogId: 51, name: 'Psychic Frog' },
      { catalogId: 52, name: 'Daze' },
      { catalogId: 53, name: 'Force of Will' },
      { catalogId: 54, name: 'Wasteland' },
      { catalogId: 55, name: 'Underground Sea' },
    ],
  },
  {
    revisionId: 206,
    name: 'Blue Terror',
    format: 'Pauper',
    archetype: '15.09% of the field',
    colors: ['U'],
    wins: 218,
    losses: 195,
    ties: 0,
    featuredCards: [
      { catalogId: 61, name: 'Tolarian Terror' },
      { catalogId: 62, name: 'Delver of Secrets' },
      { catalogId: 63, name: 'Counterspell' },
      { catalogId: 64, name: 'Lorien Revealed' },
      { catalogId: 65, name: 'Brainstorm' },
    ],
  },
  {
    revisionId: 207,
    ...
    format: 'Premodern',
    archetype: '20.36% of the field',
    colors: ['U'],
    wins: 198,
    losses: 196,
    ties: 0,
    featuredCards: [
      { catalogId: 71, name: 'Gush' },
      { catalogId: 72, name: 'Counterspell' },
      { catalogId: 73, name: 'Powder Keg' },
      { catalogId: 74, name: 'Thieving Magpie' },
      { catalogId: 75, name: 'Foil' },
    ],
  },
]
