...
import { EMPTY_TRANSITION, getPlayerZoneCards, isCreature } from "../../types/replay-types"
...
export interface BoardViewProps {
  ...
  /** Optional fallback image URL for player avatars */
  defaultAvatarUrl?: string
  /** Host-resolved card back used by libraries and hidden hands. */
  cardBackUrl?: string
  /** Host-resolved frame used for activated and triggered abilities on the stack. */
  cardFrameUrl?: string
  /** Disable the opponent top-zone drawer's hover expansion for compact embeds. */
...
export function BoardView({
  ...
  return <PopulatedBoardView board={board} {...props} />
}

function PopulatedBoardView({
  board,
  ...
  cardBackUrl,
  cardFrameUrl,
  disableTopZoneHoverExpansion = false,
}: BoardViewProps) {
  ...
  return (
    ...
    <div className="relative flex h-full min-w-0 flex-col overflow-clip bg-background">
      ...
      <TopZoneBar
        ...
        disableHoverExpansion={disableTopZoneHoverExpansion}
      />
