...
import { CardImage as SharedCardImage } from "../../cards/CardImage"
  ...
  return (
    <div className="text-xs space-y-0.5">
      ...
      {card.typeLine && !isAbility && (
        <div className="text-popover-foreground/85 text-[10px]">{card.typeLine}</div>
      )}
      {isAbility && (
      ...
      {!isAbility && nonModifierCounters.length > 0 && (
        <div className="text-popover-foreground/85 text-[10px]">
      ...
      {card.rulesText && (
        <div className="text-popover-foreground/85 text-[10px] whitespace-pre-line [&_.gl-italic]:text-popover-foreground/60">
